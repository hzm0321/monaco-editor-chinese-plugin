...
function compilationHook (wpModule) {
	...
	var endl = "\r\n";
	var code = wpModule._source._value || wpModule._source._valueAsString;
  ...
  if (wpModule._source._value) {
    wpModule._source._value = code;
  } else if(wpModule._source._valueAsString){
    wpModule._source._valueAsString = code;
  }
};
